  ...
  return (
    <div className="page">
      <div className="page-header">
        ...
        <p className="page-subtitle">Customize your QuizFlow experience</p>
      </div>
      <div className="settings-layout">
        <div className="settings-card card">
          <h3 className="settings-card-title">{'\uD83C\uDFA8'} Appearance</h3>
          <p className="settings-card-desc">Choose how QuizFlow looks to you</p>
        ...
        <div className="settings-card card">
          ...
          <p className="settings-card-desc">Get notified about quiz results and updates</p>
        ...
        <div className="settings-card card">
          <h3 className="settings-card-title">{'\uD83D\uDCBE'} Auto Save Quiz Progress</h3>
          <p className="settings-card-desc">Automatically save your quiz progress so you can resume later</p>
          <div className="settings-toggle-row mt-4">
